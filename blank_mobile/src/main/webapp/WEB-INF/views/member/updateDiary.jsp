				...
				<tr>
					<td>
						<fieldset data-role="controlgroup" data-type="horizontal">
							...
							<input type="radio" name="secret" class="secret" value=0 id="public"><label for="public">전체보기</label>
						</fieldset>
					</td>
				</tr>
				<tr>
...
<div id="grimpan" style="display: none;">
	...
	Size:<input type="range" min="1" max="5" id="Lwidth" value="1" onchange="cg_line(this.value)">
		...
		<a id="download"><button data-inline='true' style='margin:0px auto;' id="btnShowGrim"><img src="../resources/img/icon/check1.png" width="15px"></button></a>
