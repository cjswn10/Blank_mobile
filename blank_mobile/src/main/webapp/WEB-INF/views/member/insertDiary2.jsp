...
$(function() {
	...
	*/
	...
	$("#grimpanBtn").click(function() {
		
		$(location).attr("href","#grimpanCanvas");
...
<body>
<div data-role="page" id="insertMain">
			<!-- side-menu -->
				...
				<form action="insertDiary.do" method="post" enctype="multipart/form-data" style="width:95%; margin-left: auto; margin-right: auto;">
					...
					<table style="width:100%;">
						...
						<tr>
							<td>
								<!-- 그림판 버튼 -->
								<button id="grimpanBtn" type="button" style="display: inline-block;" data-ajax="false"><img src="../resources/img/icon/pencil.png" alt="그리기" width="16px">그림판</button>
...
<div data-role="page" id="grimpanCanvas">
		<div>
